                    ...
                    {isOpen && (
                      ...
                      >
                        <div className="p-6 pl-20">
                          ...
                          {/* Watch Tutorial Button - only for first item */}
                          {index === 0 && (
                            <button className="inline-flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors duration-200">
